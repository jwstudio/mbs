...
class Contact extends React.PureComponent {
  render() {
    return (
      <div id="contact" style={{backgroundColor: "#e6e6e6"}}>
      <div className="row">
        <div className="col-6" style={{backgroundColor: "#F0F0F0"}}>
          <h3>Contact Me</h3>
          <hr></hr>
          <form>
            <p>
        ...
        <div className="col-6" id="whiteBorder">
          <p>
            Ring me, send me a Whatsapp or send an email or finally you could
        ...
        <i class="bi bi-whatsapp"></i>
          ...
          <table>
            <tr>
              <th>
                <a href="tel:07400255548" tabindex="-1">
                  <button id="socialbuttons">
                    <i class="bi bi-phone"></i>
                    Call Me
                  </button>
                </a>
            ...
            <tr>
              <th>
                <a
                  target="_blank"
                  href="https://api.whatsapp.com/send?phone=447544861154"
                  tabindex="-1"
                >
                  <button id="socialbuttons">
                    <i class="bi bi-whatsapp"></i>
            ...
            <tr>
              <th>
                <a href="mailto:jameswhitby813@gmail.com" tabindex="-1">
                  <button id="socialbuttons">
                    <i class="bi bi-envelope"></i>
                    Email Me
                  </button>
              ...
              <td>martinbuildingservices@gmail.com</td>
            </tr>
          </table>
        </div>
      </div>
